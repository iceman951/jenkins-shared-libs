def call() {
    ...
    //         [$class: 'DynamicReferenceParameter', name: 'GitURL', choiceType: 'ET_FORMATTED_HTML', omitValueField: false, script: [$class: 'GroovyScript', script: [classpath: [], oldScript: '', sandbox: true, script: """ return "${gitManifestRepoSsh}" """]]],
